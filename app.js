...
paleta1.addEventListener('click', () => definePaleta('darkcyan'));
paleta2.addEventListener('click', () => definePaleta('darkblue'));
paleta3.addEventListener('click', () => definePaleta('darkred'));
